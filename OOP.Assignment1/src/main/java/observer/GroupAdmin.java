...
{
    public UndoableStringBuilder ustb = new UndoableStringBuilder(); //situation database
    public ArrayList<Member> observers = new ArrayList<Member>(); //Customer Database
